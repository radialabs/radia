# ADR-056: Radia Desktop Complete Capabilities Reference

## Status
Accepted

## Context
Radia Desktop is a comprehensive WiFi-based sensing platform that combines hardware management, real-time signal processing, neural network inference, and intelligent monitoring. This ADR documents all integrated capabilities across the desktop application and underlying crates.

## Decision
The Radia Desktop application consolidates all WiFi-DensePose functionality into a single, unified interface with the following capabilities.
