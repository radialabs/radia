...
Radia currently pins all five core RuVector crates at **v2.0.4** (from crates.io) plus a vendored `ruvector-crv` v0.1.1 and optional `ruvector-gnn` v2.0.5. The upstream RuVector workspace has moved to **v2.0.5** with meaningful improvements to the crates we depend on, and has introduced new crates that could benefit Radia's detection pipeline.

### Current Integration Map

| Radia Module | RuVector Crate | Current Version | Purpose |
|---------------|----------------|-----------------|---------|
