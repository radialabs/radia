...
**Research Document 02** | Radia Project | March 2026
...
This is the core metric used in the Radia coherence gate. For a window of $W$
...
is the variant used in the Radia coherence gate.
...
The Radia tomography module uses ISTA with an $\ell_1$ penalty for voxel-space
...
variance). The Radia longitudinal module uses Welford statistics for
...
The Radia coherence module uses Z-score-based gating to classify link quality:
...
The edge weight computation maps to existing Radia crate structure:
...
*Document prepared for the Radia project. Last updated March 2026.*
