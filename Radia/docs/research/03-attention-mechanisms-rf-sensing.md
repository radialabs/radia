...
## A Comprehensive Survey for WiFi-DensePose / Radia
...
### 9.4 Relation to Radia Codebase

The unified architecture maps directly to existing Radia modules:

| Architecture Layer | Radia Module | File |
|---|---|---|
...
design choices in the Radia/WiFi-DensePose RF topological sensing system.*
