...
Real-time sensing applications built on the Radia platform.
...
|---------|---------|-------------|
| [**radia_live.py**](radia_live.py) | CSI + mmWave + Light | Unified dashboard: HR, BR, BP, stress, presence, light, RSSI |
...
# CSI only (no mmWave)
python examples/radia_live.py --csi COM7 --mmwave none
```
