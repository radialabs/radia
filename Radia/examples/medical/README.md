...
### How This Connects to Radia

This example is part of the [Radia](https://github.com/ruvnet/Radia) ambient intelligence platform. When combined with WiFi CSI sensing:
