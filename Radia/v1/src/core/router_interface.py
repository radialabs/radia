...
class RouterInterface:
    ...
    def _initialize_mock_generator(self):
        """Load synthetic CSI generator (dev / mock mode only)."""
        from src.sensing.mock_csi_generator import MockCSIGenerator
    ...
    def _generate_mock_csi_data(self) -> np.ndarray:
        """Generate synthetic CSI when ``mock_mode`` is True."""
